...
public class Walk : MonoBehaviour
{
    ...
    public void StartGame(string id)
    {
        ...
        NetMgr.srvConn.msgDisc.AddListener("UpdateInfo", UpdateInfo); 
        NetMgr.srvConn.msgDisc.AddListener("PlayerLeave", PlayerLeave);
    }
    //发送位置
    void SendPos() 
    { 
    ...
    //更新列表
    public void GetList(ProtocolBase pro)
    {
    ...
    //更新信息（通过协议更改指定玩家的信息）
    public void UpdateInfo(ProtocolBase pro)
    {
        //获取数值
        ProtocolBytes proto = (ProtocolBytes)pro;
        int start = 0;
    ...
    //玩家离开
    public void PlayerLeave(ProtocolBase pro)
    {
        //获取数值
        ProtocolBytes proto = (ProtocolBytes)pro;
        int start = 0;
